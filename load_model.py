...
def load_model():
    ...
    parser.add_argument('--load_path', type=str, default="./params/umls-bert_tiny-desc-batch_size=64-prefix_tuning=False-max_desc_length=512-epc_85_metric_fil_hits1.pt")
    ...
    # directly run test
    parser.add_argument('--link_prediction', default=True, action='store_true')
